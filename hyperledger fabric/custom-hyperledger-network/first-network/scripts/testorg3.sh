...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ]; then
	...
	CC_SRC_PATH="/opt/gopath/src/github.com/hyperledger/fabric-samples/chaincode/tourismSubsidy/javascript/"
...
chaincodeQuery 0 2 "Tarun"

echo "Querying chaincode on peer0.org1..."
chaincodeQuery 0 1 "Tarun"
